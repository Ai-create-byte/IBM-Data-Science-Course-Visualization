...
# Define the callback function to update the input container based on the selected statistics
@app.callback(
    Output(component_id='output-container', component_property='children'),  # Use 'output-container' with a hyphen
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby(["Vehicle_Type","unenployment_rate"])["Automobile_Sales"].mean().reset_index()
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata,x="Month",y="Automobile_Sales",color="Vehicle_Type",title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(values="Advertising_Expenditure", names="Vehicle_Type",title="Total Advertisment Expenditure for Each Vehicle"))
